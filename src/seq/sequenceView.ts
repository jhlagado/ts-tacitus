...
import { OFS_META_COUNT, OFS_META_START, OFS_TYPE, seqNext } from './sequence';
...
export class SequenceView {
  ...
  public get cursor(): number {
    return vectorSimpleGet(this.heap, this.ptr, OFS_META_START + this.metaCount);
  }

  /** write the per‐sequence cursor */
  public set cursor(value: number) {
    vectorSimpleSet(this.heap, this.ptr, OFS_META_START + this.metaCount, value);
  }
}
