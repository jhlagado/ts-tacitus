...
describe('Local Variables System', () => {
  ...
  describe('Basic Operations', () => {
    test('should handle complete workflow: reserve → init → fetch', () => {
      vm.bp = RSTACK_BASE_CELLS + 16; // within current return-stack size
