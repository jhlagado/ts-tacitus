...
describe('Print Operations', () => {
  ...
  describe('Low-level raw print operation (printx)', () => {
    describe('simple values', () => {
      test('should print a simple number', () => {
        const output = captureTacitOutput('42 printx');
        expect(output[0]).toBe('42');
      });

      test('should print multiple simple values', () => {
        const output = captureTacitOutput('42 printx 84 printx');
    ...
    describe('list operations', () => {
      test('should print a tagged value', () => {
        const output = captureTacitOutput('(1 2) printx');
        expect(output[0]).toMatch(/^LIST:\d+/);
      });

      test('should handle complex list structures', () => {
        const output = captureTacitOutput('( 1 ( 2 3 ) 4 ) printx');
    ...
    describe('integration tests', () => {
      ...
      test('should work with stack operations', () => {
        const output = captureTacitOutput('42 dup printx printx');
