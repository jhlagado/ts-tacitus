...
- **Reference specs in commit messages** and code comments (sparingly, for _why_).
...
- **No comments unless requested**: Follow existing patterns exactly. If comments are necessary, focus on _why_ something is done, not _what_.
