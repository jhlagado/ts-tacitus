...
- [1. Execution Model](#1-execution-model)
  ...
  - [1.2. Resumable Functions are not Coroutines](#12-resumable-functions-are-not-coroutines)
  - [1.3. Cooperative Multitasking](#13-cooperative-multitasking)
  - [1.4. Trampolines and Yield](#14-trampolines-and-yield)
  - [1.5. Stack-Local State](#15-stack-local-state)
- [2. Memory Model](#2-memory-model)
  - [2.1. Dual Stacks: Data and Return](#21-dual-stacks-data-and-return)
  - [2.2. Frame Layout](#22-frame-layout)
  - [2.3. Handles and Promotion](#23-handles-and-promotion)
  - [2.4. No Garbage Collection](#24-no-garbage-collection)
  - [2.5. Bump Allocation and Arenas](#25-bump-allocation-and-arenas)
  - [2.6. Ownership and Lifetime](#26-ownership-and-lifetime)
- [3. Tasks and Scheduling](#3-tasks-and-scheduling)
  - [3.1. Tasks as Resumables](#31-tasks-as-resumables)
  - [3.2. Cooperative Scheduler](#32-cooperative-scheduler)
  - [3.3. Yield and Trampolines](#33-yield-and-trampolines)
  - [3.4. Task Communication (Buffers)](#34-task-communication-buffers)
  - [3.5. Deterministic Execution](#35-deterministic-execution)
- [4. Language Model and Syntax](#4-language-model-and-syntax)
  - [4.1. Minimal RPN Core](#41-minimal-rpn-core)
  - [4.2. Words and Macros](#42-words-and-macros)
  - [4.3. Locals and Return Stack](#43-locals-and-return-stack)
  - [4.4. Structs and Fields](#44-structs-and-fields)
  - [4.5. Point-Free Style](#45-point-free-style)
  - [4.6. Pipelines as Sequences](#46-pipelines-as-sequences)
- [5. Ownership and Memory](#5-ownership-and-memory)
  - [5.1. Explicit and Deterministic](#51-explicit-and-deterministic)
  - [5.2. No GC, No Closures](#52-no-gc-no-closures)
  - [5.3. Stack Cleanup and Arenas](#53-stack-cleanup-and-arenas)
  - [5.4. Promotion and Lifetime Extension](#54-promotion-and-lifetime-extension)
  - [5.5. Structs: Flat and Referenced](#55-structs-flat-and-referenced)
  - [5.6. Task Memory on Return Stack](#56-task-memory-on-return-stack)
...
- [7. Composition, Streams, and Declarative Pipelines](#7-composition-streams-and-declarative-pipelines)
  ...
  - [7.2. Pipelines as First-Class Constructs](#72-pipelines-as-first-class-constructs)
...
- [13. Design Goals and Tradeoffs](#13-design-goals-and-tradeoffs)
  ...
  - [13.6. Minimal Toolchain and Self-Contained Execution](#136-minimal-toolchain-and-self-contained-execution)
