...
`capsule` is an immediate opener used inside a colon definition to construct a capsule (see docs/specs/capsules.md). It follows the same opener/closer protocol:
